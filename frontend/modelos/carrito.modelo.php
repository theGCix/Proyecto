...
class ModeloCarrito{
	...
	static public function mdlNuevasCompras($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla (id_usuario, id_producto, metodo, email, direccion, distrito, cantidad, detalle, pago) VALUES (:id_usuario, :id_producto, :metodo, :email, :direccion, :distrito, :cantidad, :detalle, :pago)");
